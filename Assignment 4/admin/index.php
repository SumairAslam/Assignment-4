...
<head>
    ...
    <title>Shop Online Admin Panel</title>
    <style>
        * {
...
<div class="wrapper">
    <nav id="sidebar">
        <div class="sidebar-header">
            <h3><img height="100" src="../media/Logo.png"> Admin Panel</h3>
        </div>
...
<!--            </li>-->
            <li>
                <a href="index.php?del_pro">
                    <i class="fas fa-trash"></i>Delete Product</a>
            </li>
            <li>
                <a href="index.php?edit_pro">
                    <i class="fas fa-edit"></i>Edit Product Info</a>
            </li>
